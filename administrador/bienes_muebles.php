...
if ($user['user_level'] <= 2) {
    $all_detalles = find_all_bienes_muebles();
}
if ($user['user_level'] >= 3) {
    $all_detalles2 = find_by_id_bienes_muebles($user['id_detalle_user']);
}
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading clearfix">
                ...
                <a href="add_bienes_muebles.php" class="btn btn-info pull-right">Agregar información</a>
            </div>
                ...
                <table class="datatable table table-bordered table-striped">
                    <thead class="thead-purple">
                        <tr style="height: 10px;"">
                            ...
                            <th style="width: 8%;" class="text-center">Bien Mueble</th>
                    ...
                    <tbody>
                        <?php if ($user['user_level'] >= 3) : ?>
                            <?php foreach ($all_detalles2 as $a_detalle2) : ?>
                                <tr>
                                    <td class="text-center"><?php echo remove_junk(ucwords($a_detalle2['id_rel_detalle_bien_mueble'])) ?></td>
                                    ...
                                    <td><?php echo remove_junk(ucwords($a_detalle2['bien_mueble'])) ?></td>
                                    <td><?php echo remove_junk(ucwords($a_detalle2['titular'])) ?></td>
                                    <td><?php echo remove_junk(ucwords($a_detalle2['fecha_adquisicion'])) ?></td>
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="edit_bienes_muebles.php?id=<?php echo (int)$a_detalle2['id_rel_detalle_bien_mueble']; ?>" class="btn btn-warning btn-md" title="Editar" data-toggle="tooltip" style="height: 32px; width: 32px;">
                        ...
                        <?php if ($user['user_level'] <= 2) : ?>
                            <?php foreach ($all_detalles as $a_detalle) : ?>
                                <tr>
                                    <td class="text-center"><?php echo remove_junk(ucwords($a_detalle['id_rel_detalle_bien_mueble'])) ?></td>
                                    ...
                                    <td><?php echo remove_junk(ucwords($a_detalle['bien_mueble'])) ?></td>
                                    <td><?php echo remove_junk(ucwords($a_detalle['titular'])) ?></td>
                                    <td><?php echo remove_junk(ucwords($a_detalle['fecha_adquisicion'])) ?></td>
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="edit_bienes_muebles.php?id=<?php echo (int)$a_detalle['id_rel_detalle_bien_mueble']; ?>" class="btn btn-warning btn-md" title="Editar" data-toggle="tooltip" style="height: 32px; width: 32px;">
                                                <span class="material-symbols-rounded" style="font-size: 20px; color: black; margin-top: 2px; margin-left: -3px;">edit</span>
                                            </a>
                                        </div>
                                    </td>
