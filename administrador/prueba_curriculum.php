...
<?php
if (isset($_POST['prueba_curriculum'])) {
...
<div class="panel panel-default">
    ...
    <!-- <form method="post" action="prueba_curriculum.php"> -->
        ...
        <form method="post" action="prueba_curriculum.php">
            ...
            <div id="myModal" class="modal">
                <div class="modal-content">
                    ...
                    <button type="submit" name="prueba_curriculum" class="btn btn-primary btn-sm">Guardar</button>
                </div>
            </div>
...
<script>
    ...
    function checkSelect() {
        ...
        xhttp.open("POST", "prueba_curriculum.php", true); // Aquí debes especificar la ruta de tu script PHP
    ...
    // // Submit form
    // document.getElementById("prueba_curriculum").addEventListener("submit", function(event) {
