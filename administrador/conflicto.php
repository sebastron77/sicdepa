...
if ($user['user_level'] <= 2) {
    $all_detalles = find_all_conflicto();
}
if ($user['user_level'] >= 3) {
    $all_detalles2 = find_by_id_conflicto($user['id_detalle_user']);
}
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading clearfix">
                ...
                <a href="add_conflicto.php" class="btn btn-info pull-right">Agregar información</a>
            </div>
                    ...
                    <tbody>
                        <?php if ($user['user_level'] >= 3) : ?>
                            <?php foreach ($all_detalles2 as $a_detalle2) : ?>
                                <tr>
                                    <td class="text-center"><?php echo remove_junk(ucwords($a_detalle2['id_rel_detalle_conflicto_declarante'])) ?></td>
                                    ...
                                    <?php if($a_detalle2['de_acuerdo_publica'] == 0): ?>
                                    <td>No</td>
                                    <?php endif;?>
                                    <?php if($a_detalle2['de_acuerdo_publica'] == 1): ?>
                                    <td>Sí</td>
                                    <?php endif;?>
                                    ...
                                    <td class="text-center">
                                        <?php if ($a_detalle2['ninguno'] == 0) : ?>
                                            <div class="btn-group">
                                                <a href="edit_conflicto.php?id=<?php echo (int)$a_detalle2['id_rel_detalle_conflicto_declarante']; ?>" class="btn btn-warning btn-md" title="Editar" data-toggle="tooltip" style="height: 32px; width: 32px;">
                        ...
                        <?php if ($user['user_level'] <= 2) : ?>
                            <?php foreach ($all_detalles as $a_detalle) : ?>
                                <tr>
                                    <td class="text-center"><?php echo remove_junk(ucwords($a_detalle['id_rel_detalle_conflicto_declarante'])) ?></td>
                                    ...
                                    <?php if($a_detalle['de_acuerdo_publica'] == 0): ?>
                                    <td>No</td>
                                    <?php endif;?>
                                    <?php if($a_detalle['de_acuerdo_publica'] == 1): ?>
                                    <td>Sí</td>
                                    <?php endif;?>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="btn-group">
                                            <a href="edit_conflicto.php?id=<?php echo (int)$a_detalle['id_rel_detalle_conflicto_declarante']; ?>" class="btn btn-warning btn-md" title="Editar" data-toggle="tooltip" style="height: 32px; width: 32px;">
                                                <span class="material-symbols-rounded" style="font-size: 20px; color: black; margin-top: 2px; margin-left: -3px;">edit</span>
                                            </a>
                                        </div>
                                        <?php endif; ?>
